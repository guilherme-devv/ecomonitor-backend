    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('number_of_phone', models.CharField(blank=True, max_length=15, null=True, unique=True)),
                ...
                ('type', models.PositiveSmallIntegerField(choices=[(1, 'Monitor'), (2, 'Gestor')], default=1)),
